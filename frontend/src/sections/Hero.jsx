...
function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(
        ...
        .fromTo(
          imageRef.current,
          { opacity: 0, x: 70, scale: 1.08 },
          { opacity: 1, x: 0, scale: 1, duration: 1.8 },
          '-=1.1'
        )
        .fromTo(
          badgeRef.current,
        ...
        .fromTo(
          ...
          { opacity: 1, y: 0, scale: 1, duration: 0.9, stagger: 0.2 },
          '-=0.5'
        )
    }, sectionRef)
  ...
  return (
    <section
      ref={sectionRef}
      className="px-6 md:px-8 py-8 md:py-12 max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center overflow-hidden"
    >
      ...
      <div className="relative flex justify-center md:justify-end order-1 md:order-2">
        <div className="relative w-full max-w-md">
          ...
          <div
            ref={badgeRef}
            className="absolute -bottom-6 -left-6 md:-bottom-8 md:-left-8 w-20 h-20 md:w-24 md:h-24 bg-black/80 backdrop-blur rounded-full flex items-center justify-center border border-white/20"
          >
      ...
      <div className="order-2 md:order-1">
        <h1
          ref={headingRef}
          className="text-3xl md:text-5xl font-bold leading-tight mb-4 mt-10 md:mt-0"
        >
          Discover Your Dream Property with Estatein
        </h1>
        <p ref={paraRef} className="text-gray-400 mb-8 max-w-md text-sm md:text-base">
          Your journey to finding the perfect property begins here. Explore our
          listings to find the home that matches your dreams.
        </p>
        <div ref={buttonsRef} className="flex flex-col md:flex-row gap-4 mb-10">
        ...
        <div ref={statsRef} className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-md">
